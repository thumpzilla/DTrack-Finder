  ...
  e.waitUntil(
    caches.open('DTrack Finder').then(function(cache) {
      return cache.addAll([
        ...
        "https://github.com/DonRaz/Song-Instant-Selector/blob/main/images/output_512.png?raw=true",
        "https://github.com/DonRaz/Song-Instant-Selector/blob/main/images/output_192.png?raw=true",
